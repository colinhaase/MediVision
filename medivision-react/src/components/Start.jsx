  ...
  return (
    <>
      ...
      <p>
        ...
        erste Einschätzung zu erhalten. Betätigen Sie einfach{" "}
        <FiMessageSquare size={25} /> um den Chat zu starten.
      </p>
      <p>
        MediVision verfügt außerdem über die Fähigkeit Daten von wearables zu
        verarbeiten. Um ein wearable Gerät zu verbinden betätigen Sie{" "}
        <FiWatch size={25} />. Über <FiInfo size={25} />
        können Sie weitere Informationen über die Verbindung von wearables
        erhalten.
      </p>
      <p>
        Um am Ende eine komplett Analyse aller Daten im Chat als pdf zu erhalten
